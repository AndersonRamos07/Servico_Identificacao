...
{
    public class ComandoCriarUsuario : Notifiable, ICommand
    {
        public ComandoCriarUsuario() { }

        public ComandoCriarUsuario(string nome, string ultimoNome, string email, string senha, string celular)
        {
            Nome = nome;
